...
现在请开始生成，直接输出对话内容，不要添加任何其他说明、注释或解释。"""
    ...
    def build_text_to_dialogue_prompt(
        ...
        if category:
            # 根据分类提供具体指导
            category_styles = {
                "商业": "注重商业逻辑、市场分析、商业模式、案例分享，使用专业术语但要通俗易懂，对话要有深度和实用性",
                "科技": "注重技术原理、发展趋势、创新应用，保持专业性和前瞻性，语言清晰准确",
                "财经": "注重经济分析、投资理财、市场趋势，使用财经术语但要解释清楚，内容要有参考价值",
                "新闻": "注重事实陈述、多角度分析、时效性，保持客观中立，语言简洁明了",
                "影视": "注重剧情分析、角色解读、影视文化，语言生动有趣，可以引用经典台词",
                "自我成长与自愈": "注重心理分析、成长故事、情感共鸣，语言温暖治愈，要有启发性和正能量",
                "职场万象": "注重职场经验、人际关系、职业发展，语言实用接地气，要有真实感和代入感",
                "学习类": "注重知识讲解、学习方法、学习技巧，语言清晰易懂，要有实用性和可操作性",
                "娱乐八卦类": "注重趣味性、轻松幽默、话题性，语言活泼有趣，节奏可以更快",
                "考题": "注重题目解析、解题思路、知识点梳理，语言严谨清晰，逻辑要严密",
                "文化艺术": "注重文化内涵、艺术赏析、历史背景，语言优雅有深度，要有文化底蕴",
                "职场类—人际关系": "注重沟通技巧、人际交往、职场情商，语言实用友好，要有场景感和实用性",
                "学生类—求职就业": "注重求职技巧、职业规划、面试经验，语言实用指导性强，要有针对性和可操作性",
                "健康养生": "注重健康知识、养生方法、疾病预防，语言温和专业，要有科学性和实用性",
                "运动健身": "注重运动技巧、健身方法、训练计划，语言积极向上，要有激励性和可操作性",
                ...
                "心理学": "注重心理分析、行为解读、心理应用，语言专业易懂，要有科学性和实用性",
                ...
                "创业创新": "注重创业经验、创新思维、创业故事，语言激励有趣，要有启发性和实用性",
                "哲学思考": "注重哲学思辨、人生思考、价值探讨，语言深刻优雅，要有深度和启发性",
                "科学科普": "注重科学原理、科学发现、科普知识，语言清晰有趣，要有科学性和易懂性",
                "读书阅读": "注重书籍推荐、阅读心得、文学赏析，语言优雅有趣，要有深度和启发性",
                "生活方式": "注重生活技巧、生活态度、生活分享，语言轻松有趣，要有实用性和共鸣感",
                "喜剧": "注重幽默搞笑、喜剧表演、轻松对话，语言活泼有趣，要有趣味性和娱乐性",
...
{scene_types_str}
{f"5. 播客分类\n\n{category}\n{category_guidance}" if category else ""}
