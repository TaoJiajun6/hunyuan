...
class MusicSelector:
    ...
    CATEGORY_TO_MUSIC_DIR = {
        "社会文化与历史": "social_culture_history",
        "音乐": "music",
        "影视": "film",
        "书": "books",
        "喜剧/脱口秀": "comedy",
        "艺术": "art",
        "宗教与灵修": "religion_spirituality",
        "科学与科技": "science_technology",
        "时尚与美妆": "fashion_beauty",
        "健康、健身与养身": "health_fitness",
        "育儿与家庭": "parenting_family",
        "情感": "emotion",
        "生活": "life",
        "体育运动": "sports",
        "休闲娱乐与爱好": "leisure_entertainment",
        "商业与财经": "business_finance",
        "新闻": "news",
        "职场万象": "career",
        "自我成长与自愈": "self_growth",
        "学术研究": "academic"
